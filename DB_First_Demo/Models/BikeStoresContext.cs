...
public partial class BikeStoresContext : DbContext
{
    ...
    public virtual DbSet<OrderReportView> OrderReportViews { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-0TBPBTEL\\SQLEXPRESS;Database=BikeStores;Integrated Security=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27DFE3B99B");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B478BECCF3");
        ...
        {
            entity.HasKey(e => e.Empid).HasName("PK__Employee__AF2EBFA13733CCB1");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229525B6D3B");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4C22EB99C");

            entity.ToTable("order_items", "sales", tb => tb.HasTrigger("update_inventory_after_sale"));
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.OrderItems)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__order_ite__produ__14270015");
        });
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF56DC1BCCB");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9CA1596C74");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164D0349E0F").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3C6CCAB4C");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C1A94A9EF");
